...
--
-- Host: localhost
-- Generation Time: Mar 29, 2023 at 12:31 AM
...
(6, 'murrayHouseOld.png', 'alt', 'caption', 'murrayHouseOld.png', 'alt', 'capt', 'Murray House', '<p>This Historic home located at 211 S. Main St. was built in 1902 and is one of the best examples of the Queen Anne style in Gunnison. The house started its construction in 1899 and was built for a one of the Mauer sisters Lu Murray and her husband George Murray the Mauer family all living in Gunnison at the time. The house would seem to stay in the family because it was later restored by William Mauer in 1973 a two story addition was also added on to the house at the time but blends in very well with rest of the house.</p>', '<ul>\r\n  <li>Started in 1899 by Herman Mauer, the house was finished in 1902.</li>\r\n  <li>It was built for Mauer\'s sister, Lu Murray and her husband George Thomas Murray. Murray was from Nova Scotia and owned Murray\'s saloon and wholesale liquor warehouse at the northeast corner of Tomichi and Main.</li>\r\n  <li>The Murray House was restored by William Mauer in 1973.</li>\r\n  <li>The two-story Queen Anne structure has multiple cross gables and a round corner tower. A second tower provides an open porch and balcony above the main entrance. The porch and balcony have column supports.</li>\r\n  <li>Other decorative features include elaborate shingle patterning on upper story; iron finals on towers; oriel and bay windows; oval beveled window in main door.</li>\r\n  <li>A two-story addition was built on to the rear in 1973. It blends well with the entire structure. The garage is a converted carriage house.</li>\r\n</ul>\r\n');
...
(0, 'admin', '$2y$10$F.c8QsPyfVJ0oX8a.JNBsOE0yppnFQCwg/wT7ZGoK.7zfYlqqj80y'),
